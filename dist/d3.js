...
function brush$1(dim) {
  ...
  function started() {
    ...
    var that = this,
        ...
        mode = (eventModMatches(exports.event, modForceNew) ? type = "overlay" : type) === "selection" ? MODE_DRAG : (eventModMatches(exports.event, modFixCenter) ? MODE_CENTER : MODE_HANDLE),
        ...
        dy,
        moving,
        shifting = signX && signY && eventModMatches(exports.event, modFixSecondary),
        alting = eventModMatches(exports.event, modFixCenter),
        lockX,
        lockY,
        point0 = mouse(that),
        point$$1 = point0,
    ...
    function keyupped() {
      switch (exports.event.keyCode) {
        ...
        case modFixSize._keyCode: { // SPACE
          if (mode === MODE_SPACE) {
            if (eventModMatches(exports.event, modFixCenter) || alting) {
              if (signX) e0 = e1 - dx * signX, w0 = w1 + dx * signX;
              if (signY) s0 = s1 - dy * signY, n0 = n1 + dy * signY;
              mode = MODE_CENTER;
            } else {
